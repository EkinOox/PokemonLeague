...
import { BattleUseCase } from '@/app/usecases/BattleUseCase';
import { RewardsUseCase } from '@/app/usecases/RewardsUseCase';
...
import { PokemonSwitcher } from '@/components/PokemonSwitcher';
...
export default function BattlePage() {
  ...
  const moveGateway = new PokeAPIMoveGateway();
