...
describe('UseItemUseCase', () => {
  ...
  describe('Healing items', () => {
    it('should heal pokemon with potion', () => {
      ...
      expect(result.pokemon?.currentHp).toBe(70);
  ...
  describe('Revive items', () => {
    it('should revive knocked out pokemon', () => {
      ...
      expect(result.success).toBe(true);
      expect(result.pokemon?.currentHp).toBe(50); // Half of max HP
  ...
  describe('Edge cases', () => {
    ...
    it('should handle multiple item uses in sequence', () => {
      ...
      let result = useCase.execute(pokemon, potion);
      expect(result.pokemon?.currentHp).toBe(70);
      
      result = useCase.execute(result.pokemon || pokemon, potion);
      expect(result.pokemon?.currentHp).toBe(90);
    ...
    it('should handle revive followed by heal', () => {
      ...
      let result = useCase.execute(pokemon, revive);
      expect(result.pokemon?.currentHp).toBe(50);
