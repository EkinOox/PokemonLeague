...
interface GameContextType {
  ...
  replacePokemonInTeam: (pokemonToReplaceId: string, newPokemon: Pokemon) => void;
...
export function GameProvider({ children }: { children: ReactNode }) {
  ...
  const replacePokemonInTeam = (pokemonToReplaceId: string, newPokemon: Pokemon) => {
    if (gameState.player) {
      const updatedTeam = gameState.player.team.map((p: Pokemon) =>
